...
constructor(@ApplicationContext private val encryptedContext: Context) {
    ...
    companion object {
        ...
        @JvmField val RECENTS_APP_CHIP_LONG_PRESS_ACTION = backedUpItem("pref_recents_app_chip_long_press_action", "none")
        ...
        @JvmField val SHOW_QUICKSPACE_WEATHER_PROVIDER = backedUpItem("pref_quickspace_weather_provider", "seraphix")
