...
public class BaseDepthController implements LauncherPrefChangeListener {
    ...
    private boolean mAllowWallpaperZooming;
    ...
    public BaseDepthController(QuickstepLauncher activity) {
        ...
        mAllowWallpaperZooming = mLauncherPrefs.get(LauncherPrefs.ALLOW_WALLPAPER_ZOOMING);
        mLauncherPrefs.addListener(this, LauncherPrefs.ALLOW_WALLPAPER_ZOOMING);
    ...
    public void destroy() {
        mLauncherPrefs.removeListener(this, LauncherPrefs.ALLOW_WALLPAPER_ZOOMING);
    ...
    public void onPrefChanged(String key) {
        if (!LauncherPrefs.ALLOW_WALLPAPER_ZOOMING.getSharedPrefKey().equals(key)) {
            return;
        }
        boolean allowWallpaperZooming = mLauncherPrefs.get(LauncherPrefs.ALLOW_WALLPAPER_ZOOMING);
        if (mAllowWallpaperZooming == allowWallpaperZooming) {
            return;
        }
        mAllowWallpaperZooming = allowWallpaperZooming;
        applyDepthAndBlur();
    }
    ...
    private void applyDepthAndBlur(@Nullable SurfaceTransaction surfaceTransaction,
        ...
        float depth = mDepth;
        float wallpaperZoom = mAllowWallpaperZooming ? depth : 1f;
